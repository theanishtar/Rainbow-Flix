...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2023 at 08:23 PM
...
INSERT INTO `history` (`id`, `username`, `videoId`, `viewsDate`, `isLike`, `likedDate`) VALUES
...
INSERT INTO `sharevideo` (`id`, `username`, `videoId`, `email`, `shareDate`) VALUES
...
ALTER TABLE `history`
  ...
  ADD CONSTRAINT `history_ibfk_11` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ...
  ADD CONSTRAINT `history_ibfk_3` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `history_ibfk_4` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `history_ibfk_5` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `history_ibfk_6` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `history_ibfk_7` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `history_ibfk_8` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `history_ibfk_9` FOREIGN KEY (`username`) REFERENCES `account` (`username`);

--
-- Constraints for table `sharevideo`
--
ALTER TABLE `sharevideo`
  ADD CONSTRAINT `sharevideo_ibfk_1` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ...
  ADD CONSTRAINT `sharevideo_ibfk_3` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `sharevideo_ibfk_4` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `sharevideo_ibfk_5` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `sharevideo_ibfk_6` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `sharevideo_ibfk_7` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
  ADD CONSTRAINT `sharevideo_ibfk_8` FOREIGN KEY (`videoId`) REFERENCES `video` (`id`),
  ADD CONSTRAINT `sharevideo_ibfk_9` FOREIGN KEY (`username`) REFERENCES `account` (`username`);

--
-- Constraints for table `userrole`
--
ALTER TABLE `userrole`
  ADD CONSTRAINT `userrole_ibfk_1` FOREIGN KEY (`username`) REFERENCES `account` (`username`),
